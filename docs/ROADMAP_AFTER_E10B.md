...
M3-auth-1A Android Keystore identity                IMPLEMENTED; emulator instrumentation gate (scripts/android-native-gate.sh); Samsung TEE/StrongBox smoke = M-track
M3-auth-2A Android pairing + host pinning            BLOCKED on 1A device gate
