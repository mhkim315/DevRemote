...
M3b Mobile lifecycle action UX                        CODE COMPLETE (Stop/Force-Kill/Delete-History wired to production routes over host-bound device transport; capability+state gated; pure action-policy reducer; jest 267 + full build-gate PASS; physical-device/LTE smoke = M-track); see docs/M3B_IMPLEMENTATION_REPORT.md
