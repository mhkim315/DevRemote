...
func TestIPCServer_Lifecycle(t *testing.T) {
	...
	srv, err := StartIPCServer(socketPath, testMutationAuthorizer{}, nil, nil, nil, nil)
	if err != nil {
...
func TestIPCServer_RebindAfterClose(t *testing.T) {
	...
	srv1, err := StartIPCServer(socketPath, testMutationAuthorizer{}, nil, nil, nil, nil)
	if err != nil {
	...
	srv2, err := StartIPCServer(socketPath, testMutationAuthorizer{}, nil, nil, nil, nil)
	if err != nil {
