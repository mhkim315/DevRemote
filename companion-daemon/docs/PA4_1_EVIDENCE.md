...
→ both return same SHA (HEAD == upstream)

IMPL SHA: 2c34101fb2316f58934e2699e62c21199a39490c (frozen since R6)
EVID SHA: recorded externally by release-verification agent
```
