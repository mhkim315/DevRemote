...
## 12. PA3 contract proposal gate results (R15 — Final Purge + Capability Fields + Construction Timing)

Baseline SHA: `08166105a49ce9be62ef9299bce9e3e8853ac76d`
...
ok  	devremote/companion-daemon/internal/term	26.039s
ok  	devremote/companion-daemon/internal/mux	6.283s
ok  	devremote/companion-daemon/cmd/devremote	33.966s
```
